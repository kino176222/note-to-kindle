...
async function generateKindleHtml() {
    console.log('Generating Kindle HTML (Hybrid Quality Mode v3 - Wrap Fix)...');

    // Disable html:true safely or manage tags carefully. 
    // We keep html:true because we have <div> tags in MD.
    ...
    // ---------------------------------------------------------
    // Design Application (Same as before)
    // ---------------------------------------------------------
    ...
    // ---------------------------------------------------------
    // Final Output with RICH CODE BLOCK CSS (WRAPPING ENABLED)
    // ---------------------------------------------------------
    const finalHtml = `
<!DOCTYPE html>
<html lang="ja">
<head>
    ...
    <style>
        ...
        pre {
            ...
            /* CRITICAL FIX FOR KINDLE: WRAP TEXT */
...
<body>
    ...
    console.log('Final Hybrid HTML (v3 - Wrap) generated:', outputPath);
}
