...
async function generateKindleHtml() {
    console.log('Generating Kindle HTML (Hybrid Quality Mode v4 - Tight Lists)...');
    ...
    // ---------------------------------------------------------
    // Final Output with RICH CSS + TIGHT LISTS
    // ---------------------------------------------------------
    const finalHtml = `
<!DOCTYPE html>
<html lang="ja">
<head>
    ...
    <style>
        ...
        li p { margin: 0; } /* Remove paragraph margin inside lists */
        ...
        /* Code Blocks (Dark Terminal + Wrap) */
        pre {
...
<body>
    ...
    console.log('Final Hybrid HTML (v4 - Tight Lists) generated:', outputPath);
}
